from src.SQL_transformations.get_favourite_products import get_favourite_product
from src.SQL_transformations.get_products_men_and_women_love import (
    get_products_men_and_women_love,
)
from src.SQL_transformations.get_sorted_brand_performance import get_brand_performance
from src.SQL_transformations.get_num_products_sold_w_profits import (
    get_number_of_products_sold_with_profits_python,
)
from src.SQL_transformations.get_total_profits import get_total_profits
from src.SQL_transformations.get_customers_sorted_by_importance import (
    get_customers_sorted_by_importance,
)
from src.main_helpers.main_helpers import (
    get_input_output_folders,
    print_df_info_to_console,
    get_dataframes,
...
def main():
    ...
    create_data_profiles(
        dataframe_dict=dataframe_dict, base_output_folder=output_folder
    )
    ...
    get_favourite_product(dataframe_dict=dataframe_dict, gender="Male")
